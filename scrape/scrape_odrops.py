...
while True: #run until we break
    ...
    # print(pagelist)
    pageclean = pagelist['query']['pages']['11670']['transcludedin']
...
# DropsLineSkill handling
continueval = ""
while True: #run until we break
    params = {
        "action": "query",
        "prop": "transcludedin",
        "titles": "Template:DropsLineSkill",
        "tiprop": "pageid",
        "tinamespace": 0,
        "tilimit": 50,
        "ticontinue": continueval,
    ...
    pagelist = response.json()
    # print(pagelist)
    pageclean = pagelist['query']['pages']['275630']['transcludedin']
    ...
    pagelist = response.json()
    # print(pagelist)
    pageclean = pagelist['query']['pages']['296478']['transcludedin']
...
# DropsLineReward handling
continueval = ""
while True: #run until we break
    params = {
        "action": "query",
        "prop": "transcludedin",
        "titles": "Template:DropsLineReward",
        "tiprop": "pageid",
        "tinamespace": 0,
        "tilimit": 50,
        "ticontinue": continueval,
    ...
    pagelist = response.json()
    # print(pagelist)
    pageclean = pagelist['query']['pages']['218222']['transcludedin']
...
with open('scrape/drops_osw.json', 'w') as outfile:
