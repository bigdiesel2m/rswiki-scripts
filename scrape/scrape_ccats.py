...
API_URL = "https://classic.runescape.wiki/api.php" #we don't need this to change, so might as well set it here
...
while True: #run until we break
    ...
    print('current RSC progress:', len(biglist))
...
with open('scrape/categories_rsc.json', 'w') as outfile:
