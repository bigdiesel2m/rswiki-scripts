...
def get_json(id, type):
	response = requests.get('https://mejrs.github.io/data_osrs/locations/' + str(id) + '.json')
...
for i in range(len(ids)):
	data_json = data_json + get_json(ids[i], type)
...
response = outlist = ["==Locations==","{{ObjectTableHead}}"]
